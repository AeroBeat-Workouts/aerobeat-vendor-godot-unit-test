...
var _no_shine = load("res://addons/aerobeat-vendor-godot-unit-test/images/GutIconV2_no_shine.png")
var _normal = load("res://addons/aerobeat-vendor-godot-unit-test/images/GutIconV2_base.png")
