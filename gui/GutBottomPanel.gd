...
var GutConfigGui = load('res://addons/aerobeat-vendor-godot-unit-test/gui/gut_config_gui.gd')
var AboutWindow = load("res://addons/aerobeat-vendor-godot-unit-test/gui/about.tscn")
...
var _gut_config = load('res://addons/aerobeat-vendor-godot-unit-test/gut_config.gd').new()
...
func _ready():
	...
	var check_import = load('res://addons/aerobeat-vendor-godot-unit-test/images/HSplitContainer.svg')
...
func _is_test_script(script):
	...
	while(from and from.resource_path != 'res://addons/aerobeat-vendor-godot-unit-test/test.gd'):
...
func _run_tests():
	...
	if(_ctrls.run_externally_dialog.should_run_externally()):
		...
		_interface.play_custom_scene('res://addons/aerobeat-vendor-godot-unit-test/gui/run_from_editor.tscn')
