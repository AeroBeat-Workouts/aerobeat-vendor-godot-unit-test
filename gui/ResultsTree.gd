...
var _icons = {
	red = load('res://addons/aerobeat-vendor-godot-unit-test/images/red.png'),
	green = load('res://addons/aerobeat-vendor-godot-unit-test/images/green.png'),
	yellow = load('res://addons/aerobeat-vendor-godot-unit-test/images/yellow.png'),
}
