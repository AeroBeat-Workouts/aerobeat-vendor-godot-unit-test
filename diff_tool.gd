extends 'res://addons/aerobeat-vendor-godot-unit-test/compare_result.gd'
const INDENT = '    '
enum {
	DEEP,
	SIMPLE
...
func summarize():
	...
	if(are_equal):
		...
		var formatter = load('res://addons/aerobeat-vendor-godot-unit-test/diff_formatter.gd').new()
