...
# Private
# ###############
var _func_text = GutUtils.get_file_as_text('res://addons/aerobeat-vendor-godot-unit-test/double_templates/function_template.txt')
var _init_text = GutUtils.get_file_as_text('res://addons/aerobeat-vendor-godot-unit-test/double_templates/init_template.txt')
