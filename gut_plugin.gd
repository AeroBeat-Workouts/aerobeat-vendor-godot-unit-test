...
var VersionConversion = load("res://addons/aerobeat-vendor-godot-unit-test/version_conversion.gd")
var MenuManager = load("res://addons/aerobeat-vendor-godot-unit-test/gut_menu.gd")
var BottomPanelScene = preload('res://addons/aerobeat-vendor-godot-unit-test/gui/GutBottomPanel.tscn')
var GutEditorGlobals = load('res://addons/aerobeat-vendor-godot-unit-test/gui/editor_globals.gd')
var GutDock = load('res://addons/aerobeat-vendor-godot-unit-test/gui/gut_dock.gd')
var UpdateRequiredDialog = load('res://addons/aerobeat-vendor-godot-unit-test/gui/update_required.tscn')
var CheckForUpdateControl = load("res://addons/aerobeat-vendor-godot-unit-test/gui/check_for_update.tscn")
...
func _version_conversion():
	var EditorGlobals = load("res://addons/aerobeat-vendor-godot-unit-test/gui/editor_globals.gd")
