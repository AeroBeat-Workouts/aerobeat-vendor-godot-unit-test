...
func _set_font(rtl, font_name, custom_name):
	if(font_name == null):
		...
		var font_path = 'res://addons/aerobeat-vendor-godot-unit-test/fonts/' + font_name + '.ttf'
		if(FileAccess.file_exists(font_path)):
			var dyn_font = FontFile.new()
			dyn_font.load_dynamic_font('res://addons/aerobeat-vendor-godot-unit-test/fonts/' + font_name + '.ttf')
