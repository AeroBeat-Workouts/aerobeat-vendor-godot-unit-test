...
## -----------------------------------------------------------------------------
var Vnt = load("res://addons/aerobeat-vendor-godot-unit-test/version_numbers.gd").VerNumTools


const REMOTE_FILE_URL = "https://api.github.com/repos/bitwes/gut/contents/addons/gut/versions.json"
const LOCAL_FILE_PATH = "res://addons/aerobeat-vendor-godot-unit-test/versions.json"
